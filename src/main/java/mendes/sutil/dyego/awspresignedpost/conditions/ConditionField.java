...
public enum ConditionField {
  ...
  /**
   * Does not start with '$', indicates a condition to be fulfilled for the upload to be successful.
   * This value is the one to be used as parameters in the client used to perform the POST to S3 AWS
   */
